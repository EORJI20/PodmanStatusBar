...
## 🌟 Features  
- Quick access to start and stop your Podman VM.  
- Easy status checks directly from your menu bar.  
...
Once the download is complete, locate the downloaded file in your 'Downloads' folder. Double-click on the file to open it. If you downloaded a `.dmg` file, you may need to drag the PodmanStatusBar icon to your 'Applications' folder.  

### 4. Launch PodmanStatusBar  
After moving the app to your 'Applications' folder, you can open it by finding PodmanStatusBar in your Applications. Double-click the icon to launch the app.  

### 5. Grant Permissions  
The first time you launch PodmanStatusBar, macOS may prompt you to allow the app to run. If any security warnings appear, follow the prompts to allow it to run.

### 6. Configure the App  
Once PodmanStatusBar is open, you may need to configure it to connect to your Podman VM. Follow the built-in instructions to set it up according to your needs.  

## ⚙️ Using PodmanStatusBar  

- **Start the Podman VM**: Click the "Start" button to power on your VM.  
- **Stop the Podman VM**: Click the "Stop" button when you want to turn off the VM.  
...
## 🔖 Topics  
apple, containers, macOS, menubar, menubar-app, open-source, podman, statusbar, swift, utility